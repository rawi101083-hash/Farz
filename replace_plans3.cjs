            ...
            <div className="space-y-12 max-w-5xl mx-auto pb-10">
              ...
              {billingCycle === 'subscription' && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {/* Growth */}
                  <div className="relative bg-white dark:bg-slate-800 rounded-[2rem] p-10 border border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-2xl hover:shadow-slate-200/50 dark:hover:shadow-none transition-all duration-300 flex flex-col group hover:-translate-y-2">
                    <div className="mb-8">
                    ...
                    <div className="mb-8 border-b border-slate-100 dark:border-slate-700/50 pb-8">
                      <div className="flex items-end gap-1 mb-2">
                        <span className="text-5xl font-black text-navy dark:text-white tracking-tight">499</span>
                        <span className="text-sm font-bold text-slate-400 mb-1.5">ريال / شهرياً</span>
                      </div>
                      <div className="flex items-center gap-2 mt-2">
                        <p className="text-xs font-bold text-slate-400">أو 4,990 ريال سنوياً</p>
                        <span className="text-[10px] font-black bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 px-2.5 py-1 rounded-md tracking-wider">وفر قيمة شهرين</span>
                      </div>
                    </div>
                  ...
                  <div className="relative bg-white dark:bg-slate-800 rounded-[2rem] p-10 border-2 border-primary shadow-2xl shadow-primary/10 dark:shadow-none flex flex-col transform md:-translate-y-4 hover:-translate-y-6 transition-all duration-300 z-10">
                    ...
                    <div className="mb-8 border-b border-primary/10 pb-8 relative z-10">
                      <div className="flex items-end gap-1 mb-2">
                        <span className="text-5xl font-black text-navy dark:text-white tracking-tight">1,499</span>
                        <span className="text-sm font-bold text-slate-400 mb-1.5">ريال / شهرياً</span>
                      </div>
                      <div className="flex items-center gap-2 mt-2">
                        <p className="text-xs font-bold text-slate-400">أو 14,990 ريال سنوياً</p>
                        <span className="text-[10px] font-black bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary-light px-2.5 py-1 rounded-md tracking-wider">وفر 2,990 ريال</span>
                      </div>
                    </div>
                    ...
                    <button onClick={() => { setUserProfile({...userProfile, subscription_tier: 'business'}); alert('تم الترقية إلى باقة أعمال بنجاح (وضع المحاكاة).'); }} className="w-full bg-primary hover:bg-primary-dark text-white shadow-xl shadow-primary/40 py-4 rounded-xl font-bold transition-all duration-300 active:scale-95 text-sm tracking-wide relative z-10">
                  ...
                  <div className="relative bg-white dark:bg-slate-800 rounded-[2rem] p-10 border border-slate-200 dark:border-slate-700 shadow-lg hover:shadow-2xl hover:shadow-slate-200/50 dark:hover:shadow-none transition-all duration-300 flex flex-col group hover:-translate-y-2">
                    ...
                    <div className="mb-8 border-b border-slate-100 dark:border-slate-700/50 pb-8">
                      <div className="flex items-end gap-1 mb-2">
                        <span className="text-5xl font-black text-navy dark:text-white tracking-tight">3,499</span>
                        <span className="text-sm font-bold text-slate-400 mb-1.5">ريال / شهرياً</span>
                      </div>
                      <div className="flex items-center gap-2 mt-2">
                        <p className="text-xs font-bold text-slate-400">أو 34,990 ريال سنوياً</p>
                        <span className="text-[10px] font-black bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 px-2.5 py-1 rounded-md tracking-wider">وفر قيمة شهرين</span>
                      </div>
                    </div>
                    <ul className="space-y-5 mb-10 flex-1">
              ...
              {billingCycle === 'one-time' && (
                <div className="max-w-md mx-auto">
                  <div className="relative bg-white dark:bg-slate-800 rounded-[2rem] p-10 border border-slate-200 dark:border-slate-700 shadow-2xl shadow-slate-200/50 dark:shadow-none flex flex-col hover:-translate-y-2 transition-all duration-300">
                    <div className="mb-8">
                    ...
                    <div className="mb-8 border-b border-slate-100 dark:border-slate-700/50 pb-8">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <span className="text-[10px] font-black bg-slate-100 text-slate-500 dark:bg-slate-700 dark:text-slate-300 px-2.5 py-1 rounded-md tracking-wider uppercase">تدفع لمرة واحدة</span>
                      </div>
                    </div>
                    <ul className="space-y-5 mb-10 flex-1">
                      <li className="flex items-start gap-3">
                    ...
                    <button onClick={() => { setUserProfile({...userProfile, subscription_tier: 'one-time'}); alert('تم الاشتراك في باقة الإعلان الواحد بنجاح (وضع المحاكاة).'); }} className="w-full bg-primary hover:bg-primary-dark text-white shadow-xl shadow-primary/30 py-4 rounded-xl font-bold transition-all duration-300 active:scale-95 text-sm tracking-wide">
