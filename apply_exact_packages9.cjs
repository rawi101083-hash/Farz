              ...
              {billingCycle === 'one-time' && (
                <div className="flex justify-center w-full mt-2">
                  ...
                  <div className="w-full max-w-[280px] bg-white dark:bg-slate-800 rounded-2xl p-8 border-2 border-[#0D9488] shadow-2xl shadow-[#0D9488]/20 flex flex-col items-center">
                    ...
                    <div className="bg-emerald-100 text-emerald-600 text-[10px] font-bold px-3 py-1 rounded mb-8 opacity-0 pointer-events-none text-center w-fit">
                      شهرين مجاناً
                    </div>
...
console.log('Successfully reverted to strict squares and old arrangement.');
