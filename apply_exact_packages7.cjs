              ...
              <div className="flex flex-col items-center gap-5 mb-4">
                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-1.5 rounded-full flex gap-1 shadow-inner">
                  <button
                    ...
                    className={\`px-6 py-2.5 rounded-full text-sm font-black transition-all \${billingCycle === 'subscription' ? 'bg-[#0D9488] text-white shadow-md transform scale-105' : 'text-slate-500 hover:text-navy dark:hover:text-white'}\`}
                  >
                    اشتراكات مستمرة
                  </button>
                  <button
                    onClick={() => setBillingCycle('one-time')}
                    className={\`px-6 py-2.5 rounded-full text-sm font-black transition-all \${billingCycle === 'one-time' ? 'bg-[#0D9488] text-white shadow-md transform scale-105' : 'text-slate-500 hover:text-navy dark:hover:text-white'}\`}
                  >
                    توظيف لمرة واحدة
                  </button>
                </div>
...
console.log('Successfully combined small card sizes with heavy readable fonts.');
