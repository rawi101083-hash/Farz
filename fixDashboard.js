...
// Find the start of the table headers
...
// Find the first line after the corrupted section, which seems to be:
...
// We need to restore everything from <tbody> down to the start of the onClick handler for the first column.
