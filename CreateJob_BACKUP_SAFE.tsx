                  ...
                  <div className="bg-white border-slate-200 dark:bg-slate-800 p-8 rounded-[32px] border dark:border-slate-700 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-3">
                        <label className="text-sm font-bold text-navy dark:text-white mr-1 flex items-center gap-1">
                          ┘à┘é╪▒ ╪د┘╪╣┘à┘ / ╪د┘┘à╪»┘ <Sparkles size={14} className="text-primary/70" /> <span className="text-red-500">*</span>
                        </label>
                        <SearchableSelect
                      ...
                      <div className="space-y-3">
                        <label className="text-sm font-bold text-navy dark:text-white mr-1 flex items-center gap-1">
                          ┘┘ê╪╣ ╪د┘╪╣┘à┘ <Sparkles size={14} className="text-primary/70" /> <span className="text-red-500">*</span>
                        </label>
                                    ...
                                    >
                                      <div className="p-6 flex flex-col gap-4 bg-white dark:bg-slate-800/50">
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-4">
                                          ...
                                          <button type="button" onClick={() => { setNewAttachmentName("╪د┘╪╡┘ê╪▒╪ر ╪د┘╪┤╪«╪╡┘è╪ر"); setNewAttachmentType("image"); }} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-600 dark:text-slate-300 text-xs font-bold rounded-lg transition-colors border border-slate-200 dark:border-slate-600 flex items-center gap-1"><Plus size={14} /> ╪د┘╪╡┘ê╪▒╪ر ╪د┘╪┤╪«╪╡┘è╪ر</button>
                                          <button type="button" onClick={() => { setNewAttachmentName("╪▒╪«╪╡╪ر ╪د┘┘é┘è╪د╪»╪ر"); setNewAttachmentType("mixed_file"); }} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-600 dark:text-slate-300 text-xs font-bold rounded-lg transition-colors border border-slate-200 dark:border-slate-600 flex items-center gap-1"><Plus size={14} /> ╪▒╪«╪╡╪ر ╪د┘┘é┘è╪د╪»╪ر</button>
                                          <button type="button" onClick={() => { setNewAttachmentName("╪╡┘ê╪▒╪ر ╪د┘┘ç┘ê┘è╪ر"); setNewAttachmentType("mixed_file"); }} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-600 dark:text-slate-300 text-xs font-bold rounded-lg transition-colors border border-slate-200 dark:border-slate-600 flex items-center gap-1"><Plus size={14} /> ╪╡┘ê╪▒╪ر ╪د┘┘ç┘ê┘è╪ر</button>
                                          <button type="button" onClick={() => { setNewAttachmentName("╪▒╪د╪ذ╪╖ ┘à╪╣╪▒╪╢ ╪د┘╪ث╪╣┘à╪د┘"); setNewAttachmentType("link"); }} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-600 dark:text-slate-300 text-xs font-bold rounded-lg transition-colors border border-slate-200 dark:border-slate-600 flex items-center gap-1"><Plus size={14} /> ╪▒╪د╪ذ╪╖ ┘à╪╣╪▒╪╢ ╪د┘╪ث╪╣┘à╪د┘</button>
                                        </div>
        ...
        <form onSubmit={async (e) => {
          ...
          {entityType === "company" ? (
            <div>
              ...
              }} maxLength={10} minLength={10} placeholder="┘à╪س╪د┘: 1010123456" className="w-full px-5 py-4 rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 outline-none focus:border-orange-400 focus:ring-4 focus:ring-orange-100 dark:focus:ring-orange-900/30 font-medium dark:text-white text-left transition-all" dir="ltr" />
            </div>
          ) : (
            <div>
          ...
          <div>
            <label className="text-sm font-bold text-slate-700 dark:text-slate-300 block mb-2 mr-1">╪د┘┘à╪»┘è┘╪ر (╪د╪«╪ز┘è╪د╪▒┘è)</label>
